...
import 'package:shop_z/src/theme/AppColors.dart';
...
ThemeData buildLightTheme() {
  final colorScheme = ColorScheme.light(
    primary: AppPalettesColors.light.primary,
    surface: AppPalettesColors.light.surface,
    onSurface: AppPalettesColors.light.onSurface,
    secondary: AppPalettesColors.light.secondary,
    onSurfaceVariant: AppPalettesColors.light.onsurfaceVariant,
  );
...
ThemeData buildDarkTheme() {
  final colorScheme = ColorScheme.dark(
    primary: AppPalettesColors.dark.primary,
    surface: AppPalettesColors.dark.surface,
    onSurface: AppPalettesColors.dark.onSurface,
    secondary: AppPalettesColors.dark.secondary,
    onSurfaceVariant: AppPalettesColors.dark.onsurfaceVariant,
  );
